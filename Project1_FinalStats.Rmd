...
## Co-occurrence
This section was used to determine if there was overlap between landscape factors and reduce it. It was further aimed at trying to help us understand where cross affiliation occurs (even somewhat naturally) with gas fluxes and spatial heterogeneity.
```{r}
library(dplyr)
library(ggplot2)
